...
public class ConfigDemo {
    ...
    public void maxRedirectsTest() {
         RestAssured.config = RestAssured.config().redirect(redirectConfig().followRedirects(true)); //turn off redirection
    ...
    public void failureConfigExample() {
        ResponseValidationFailureListener failureListener=
                (reqSpec,resSpec,response)-> System.out.printf("We have a failure " + "response status was %s and the body contained: %s",
